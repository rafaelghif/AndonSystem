...
Public Class AcceptForm
    ...
    Private Sub Initialization()
        ...
        listDatabases = GetIssueList(combinedDatabases)
    ...
    Private Function GetIssueList(databases As String()) As List(Of String)
        Dim issueLists As New List(Of String)

        If databases IsNot Nothing Then
            For Each issueList As String In databases
                If issueList.Contains("ISSUE") Then
    ...
    Private Function GetSupportLists(userType As String, databases As String()) As List(Of String)
        ...
        If databases IsNot Nothing Then
            For Each supportList As String In databases
                ...
                If supportStatus = "ISSUE" AndAlso supportType = userType Then
